...
class MoveTestCase(unittest.TestCase):
    ...
    def test_equality(self):
        a = chess.Move(None, chess.A1, chess.A2)
        b = chess.Move(None, chess.A1, chess.A2)
        c = chess.Move(None, chess.H7, chess.H8, chess.BISHOP)
        d1 = chess.Move(None, chess.H7, chess.H8)
        d2 = chess.Move(None, chess.H7, chess.H8)
    ...
    def test_uci_parsing(self):
        self.assertEqual(chess.Move.from_uci(chess.Board(), "b5c7").uci(), "b5c7")
        self.assertEqual(chess.Move.from_uci(chess.Board(), "e7e8q").uci(), "e7e8q")
        self.assertEqual(chess.Move.from_uci(chess.Board(), "P@e4").uci(), "P@e4")
        self.assertEqual(chess.Move.from_uci(chess.Board(), "B@f4").uci(), "B@f4")
        self.assertEqual(chess.Move.from_uci(chess.Board(), "0000").uci(), "0000")
    ...
    def test_invalid_uci(self):
        ...
        with self.assertRaises(chess.InvalidMoveError):
            chess.Move.from_uci(chess.Board(), "N")

        with self.assertRaises(chess.InvalidMoveError):
            chess.Move.from_uci(chess.Board(), "z1g3")

        with self.assertRaises(chess.InvalidMoveError):
            chess.Move.from_uci(chess.Board(), "Q@g9")

    def test_xboard_move(self):
        self.assertEqual(chess.Move.from_uci(chess.Board(), "b5c7").xboard(), "b5c7")
        self.assertEqual(chess.Move.from_uci(chess.Board(), "e7e8q").xboard(), "e7e8q")
        self.assertEqual(chess.Move.from_uci(chess.Board(), "P@e4").xboard(), "P@e4")
        self.assertEqual(chess.Move.from_uci(chess.Board(), "B@f4").xboard(), "B@f4")
        self.assertEqual(chess.Move.from_uci(chess.Board(), "0000").xboard(), "@@@@")

    def test_copy(self):
        a = chess.Move.from_uci(chess.Board(), "N@f3")
        b = chess.Move.from_uci(chess.Board(), "a1h8")
        c = chess.Move.from_uci(chess.Board(), "g7g8r")
...
class PieceTestCase(unittest.TestCase):
    ...
    def test_equality(self):
        a = chess.Piece(None, chess.BISHOP, chess.WHITE)
        b = chess.Piece(None, chess.KING, chess.BLACK)
        c = chess.Piece(None, chess.KING, chess.WHITE)
        d1 = chess.Piece(None, chess.BISHOP, chess.WHITE)
        d2 = chess.Piece(None, chess.BISHOP, chess.WHITE)
    ...
    def test_from_symbol(self):
        white_knight = chess.Piece.from_symbol(chess.Board(), "N")
        ...
        black_queen = chess.Piece.from_symbol(chess.Board(), "q")
...
class BoardTestCase(unittest.TestCase):
    ...
    def test_default_position(self):
        board = chess.Board()
        self.assertEqual(board.piece_at(chess.B1), chess.Piece.from_symbol(chess.Board(), "N"))
    ...
    def test_fen(self):
        ...
        board.push(chess.Move.from_uci(chess.Board(), "f3d2"))
    ...
    def test_get_set(self):
        ...
        board.set_piece_at(chess.E4, chess.Piece.from_symbol(chess.Board(), "r"))
        ...
        board.set_piece_at(chess.H7, chess.Piece.from_symbol(chess.Board(), "Q"), promoted=True)
    ...
    def test_pawn_captures(self):
        ...
        # King's Gambit.
        board.push(chess.Move.from_uci(chess.Board(), "e2e4"))
        board.push(chess.Move.from_uci(chess.Board(), "e7e5"))
        board.push(chess.Move.from_uci(chess.Board(), "f2f4"))

        # Accepted.
        exf4 = chess.Move.from_uci(chess.Board(), "e5f4")
    ...
    def test_single_step_pawn_move(self):
        board = chess.Board()
        a3 = chess.Move.from_uci(chess.Board(), "a2a3")
    ...
    def test_castling(self):
        ...
        self.assertEqual(move, chess.Move.from_uci(chess.Board(), "e1g1"))
    ...
    def test_castling_san(self):
        ...
        self.assertEqual(board.parse_san("O-O"), chess.Move.from_uci(chess.Board(), "e1g1"))
    ...
    def test_ninesixty_castling(self):
        ...
        self.assertNotIn(chess.Move.from_uci(chess.Board(), "e8h8"), board.legal_moves)
    ...
    def test_hside_rook_blocks_aside_castling(self):
        ...
        self.assertNotIn(chess.Move.from_uci(chess.Board(), "g1f1"), board.legal_moves)
        self.assertNotIn(chess.Move.from_uci(chess.Board(), "g1e1"), board.legal_moves)
        self.assertNotIn(chess.Move.from_uci(chess.Board(), "g1c1"), board.legal_moves)
        self.assertNotIn(chess.Move.from_uci(chess.Board(), "g1a1"), board.legal_moves)
        self.assertIn(chess.Move.from_uci(chess.Board(), "g1h1"), board.legal_moves)  # Kh1
    ...
    def test_ninesixty_prevented_castle(self):
        ...
        self.assertFalse(board.is_legal(chess.Move.from_uci(chess.Board(), "g1f1")))

    def test_find_move(self):
        board = chess.Board("4k3/1P6/8/8/8/8/3P4/4K2R w K - 0 1")

        # Pawn moves.
        self.assertEqual(board.find_move(chess.D2, chess.D4), chess.Move.from_uci(chess.Board(), "d2d4"))
        self.assertEqual(board.find_move(chess.B7, chess.B8), chess.Move.from_uci(chess.Board(), "b7b8q"))
        self.assertEqual(board.find_move(chess.B7, chess.B8, chess.KNIGHT), chess.Move.from_uci(chess.Board(), "b7b8n"))
        ...
        # Castling.
        self.assertEqual(board.find_move(chess.E1, chess.G1), chess.Move.from_uci(chess.Board(), "e1g1"))
        self.assertEqual(board.find_move(chess.E1, chess.H1), chess.Move.from_uci(chess.Board(), "e1g1"))
        board.chess960 = True
        self.assertEqual(board.find_move(chess.E1, chess.H1), chess.Move.from_uci(chess.Board(), "e1h1"))
    ...
    def test_promotion_with_check(self):
        ...
        board.push(chess.Move.from_uci(chess.Board(), "g7g8q"))
    ...
    def test_scholars_mate(self):
        ...
        e4 = chess.Move.from_uci(chess.Board(), "e2e4")
        self.assertIn(e4, board.legal_moves)
        board.push(e4)

        e5 = chess.Move.from_uci(chess.Board(), "e7e5")
        self.assertIn(e5, board.legal_moves)
        board.push(e5)

        Qf3 = chess.Move.from_uci(chess.Board(), "d1f3")
        self.assertIn(Qf3, board.legal_moves)
        board.push(Qf3)

        Nc6 = chess.Move.from_uci(chess.Board(), "b8c6")
        self.assertIn(Nc6, board.legal_moves)
        board.push(Nc6)

        Bc4 = chess.Move.from_uci(chess.Board(), "f1c4")
        self.assertIn(Bc4, board.legal_moves)
        board.push(Bc4)

        Rb8 = chess.Move.from_uci(chess.Board(), "a8b8")
        ...
        Qf7_mate = chess.Move.from_uci(chess.Board(), "f3f7")
    ...
    def test_san(self):
        ...
        board = chess.Board(fen)
        long_castle_check = chess.Move.from_uci(chess.Board(), "e1a1")
        ...
        board = chess.Board(fen)
        fxe6_mate_ep = chess.Move.from_uci(chess.Board(), "e5d6")
        ...
        board = chess.Board(fen)
        self.assertEqual(board.san(chess.Move.from_uci(chess.Board(), "e1f1")), "Kf1")
        self.assertEqual(board.san(chess.Move.from_uci(chess.Board(), "c3c2")), "Rcc2")
        self.assertEqual(board.san(chess.Move.from_uci(chess.Board(), "b2c2")), "Rbc2")
        self.assertEqual(board.san(chess.Move.from_uci(chess.Board(), "a4b6")), "N4b6")
        self.assertEqual(board.san(chess.Move.from_uci(chess.Board(), "h8g6")), "N8g6")
        self.assertEqual(board.san(chess.Move.from_uci(chess.Board(), "h4g6")), "Nh4g6")
        self.assertEqual(board.fen(), fen)

        # Do not disambiguate illegal alternatives.
        fen = "8/8/8/R2nkn2/8/8/2K5/8 b - - 0 1"
        board = chess.Board(fen)
        self.assertEqual(board.san(chess.Move.from_uci(chess.Board(), "f5e3")), "Ne3+")
        self.assertEqual(board.fen(), fen)

        # Promotion.
        fen = "7k/1p2Npbp/8/2P5/1P1r4/3b2QP/3q1pPK/2RB4 b - - 1 29"
        board = chess.Board(fen)
        self.assertEqual(board.san(chess.Move.from_uci(chess.Board(), "f2f1q")), "f1=Q")
        self.assertEqual(board.san(chess.Move.from_uci(chess.Board(), "f2f1n")), "f1=N+")
        self.assertEqual(board.fen(), fen)
    ...
    def test_lan(self):
        ...
        fen = "N3k2N/8/8/3N4/N4N1N/2R5/1R6/4K3 w - - 0 1"
        board = chess.Board(fen)
        self.assertEqual(board.lan(chess.Move.from_uci(chess.Board(), "e1f1")), "Ke1-f1")
        self.assertEqual(board.lan(chess.Move.from_uci(chess.Board(), "c3c2")), "Rc3-c2")
        self.assertEqual(board.lan(chess.Move.from_uci(chess.Board(), "a4c5")), "Na4-c5")
        self.assertEqual(board.fen(), fen)

        # Normal capture.
        fen = "rnbq1rk1/ppp1bpp1/4pn1p/3p2B1/2PP4/2N1PN2/PP3PPP/R2QKB1R w KQ - 0 7"
        board = chess.Board(fen)
        self.assertEqual(board.lan(chess.Move.from_uci(chess.Board(), "g5f6")), "Bg5xf6")
        self.assertEqual(board.fen(), fen)

        # Pawn captures and moves.
        fen = "6bk/7b/8/3pP3/8/8/8/Q3K3 w - d6 0 2"
        board = chess.Board(fen)
        self.assertEqual(board.lan(chess.Move.from_uci(chess.Board(), "e5d6")), "e5xd6#")
        self.assertEqual(board.lan(chess.Move.from_uci(chess.Board(), "e5e6")), "e5-e6+")
        self.assertEqual(board.fen(), fen)
    ...
    def test_is_legal_move(self):
        ...
        self.assertIn(chess.Move.from_uci(chess.Board(), "e1g1"), board.legal_moves)
        self.assertIn(chess.Move.from_uci(chess.Board(), "g7g8r"), board.legal_moves)

        # Impossible promotion: Kb5, h7.
        self.assertNotIn(chess.Move.from_uci(chess.Board(), "a5b5q"), board.legal_moves)
        self.assertNotIn(chess.Move.from_uci(chess.Board(), "h6h7n"), board.legal_moves)

        # Missing promotion.
        self.assertNotIn(chess.Move.from_uci(chess.Board(), "g7g8"), board.legal_moves)

        # Promote to pawn or king.
        self.assertFalse(board.is_legal(chess.Move.from_uci(chess.Board(), "g7g8p")))
        self.assertFalse(board.is_pseudo_legal(chess.Move.from_uci(chess.Board(), "g7g8p")))
        self.assertFalse(board.is_legal(chess.Move.from_uci(chess.Board(), "g7g8k")))
        self.assertFalse(board.is_pseudo_legal(chess.Move.from_uci(chess.Board(), "g7g8k")))
    ...
    def test_castling_move_generation_bug(self):
        ...
        board = chess.Board(fen)
        illegal_move = chess.Move.from_uci(chess.Board(), "g1g2")
        ...
        illegal_move = chess.Move.from_uci(chess.Board(), "e1c1")
        self.assertNotIn(illegal_move, board.pseudo_legal_moves)
    ...
    def test_move_generation_bug(self):
        ...
        illegal_move = chess.Move.from_uci(chess.Board(), "e8f8")
        self.assertNotIn(illegal_move, board.pseudo_legal_moves)
        self.assertNotIn(illegal_move, board.generate_pseudo_legal_moves())
        self.assertNotIn(illegal_move, board.legal_moves)
    ...
    def test_ninesixty_castling_bug(self):
        ...
        move = chess.Move.from_uci(chess.Board(), "d1b1")
    ...
    def test_epd(self):
        ...
        epd = board.epd(pv=[
            chess.Move.from_uci(chess.Board(), "g1f3"),  # Nf3
            chess.Move.from_uci(chess.Board(), "a8a7"),  # Ka7
            chess.Move.from_uci(chess.Board(), "e1h1"),  # O-O
        ])
        ...
        epd = board.epd(bm=[
            chess.Move.from_uci(chess.Board(), "e5e6"),  # Ke6
            chess.Move.from_uci(chess.Board(), "e5e4"),  # Ke4
        ])
        ...
        self.assertIn(chess.Move.from_uci(chess.Board(), "d6b8"), operations["bm"])
        self.assertIn(chess.Move.from_uci(chess.Board(), "d6e7"), operations["bm"])
        ...
        self.assertEqual(operations["pv"][0], chess.Move.from_uci(chess.Board(), "h1h7"))
        self.assertEqual(operations["pv"][1], chess.Move.from_uci(chess.Board(), "g8f8"))
        self.assertEqual(operations["pv"][2], chess.Move.from_uci(chess.Board(), "h7f7"))
        ...
        self.assertEqual(operations["bm"], [chess.Move.from_uci(chess.Board(), "f3g5")])
        ...
        self.assertEqual(operations["bm"], [chess.Move.from_uci(chess.Board(), "d6d1")])
    ...
    def test_eret_epd(self):
        ...
        self.assertEqual(ops["bm"], [chess.Move.from_uci(chess.Board(), "f1f4")])
    ...
    def test_null_moves(self):
        ...
        self.assertEqual(chess.Move.from_uci(chess.Board(), "0000"), board.push_san("--"))
    ...
    def test_ep_legality(self):
        move = chess.Move.from_uci(chess.Board(), "h5g6")
        ...
        move = chess.Move.from_uci(chess.Board(), "c4d3")
    ...
    def test_pseudo_legal_castling_masks(self):
        ...
        kingside = chess.Move.from_uci(chess.Board(), "e1g1")
        queenside = chess.Move.from_uci(chess.Board(), "e1c1")
    ...
    def test_horizontally_skewered_en_passant(self):
        ...
        move = chess.Move.from_uci(chess.Board(), "d5e6")
        self.assertEqual(board.status(), chess.STATUS_VALID)
        self.assertTrue(board.is_pseudo_legal(move))
        self.assertIn(move, board.generate_pseudo_legal_moves())
    ...
    def test_diagonally_skewered_en_passant(self):
        ...
        move = chess.Move.from_uci(chess.Board(), "f5e6")
        ...
        move = chess.Move.from_uci(chess.Board(), "f4e3")
        self.assertTrue(board.is_pseudo_legal(move))
        self.assertIn(move, board.generate_pseudo_legal_moves())
        self.assertIn(move, board.generate_pseudo_legal_ep())
        self.assertFalse(board.is_legal(move))
        ...
        move = chess.Move.from_uci(chess.Board(), "h4g3")
        self.assertTrue(board.is_pseudo_legal(move))
        self.assertIn(move, board.generate_pseudo_legal_moves())
        self.assertIn(move, board.generate_pseudo_legal_ep())
        self.assertFalse(board.is_legal(move))
    ...
    def test_file_pinned_en_passant(self):
        ...
        move = chess.Move.from_uci(chess.Board(), "d4e3")
        self.assertTrue(board.is_pseudo_legal(move))
        self.assertIn(move, board.generate_pseudo_legal_moves())
        self.assertIn(move, board.generate_pseudo_legal_ep())
        self.assertFalse(board.is_legal(move))
    ...
    def test_capture_generation(self):
        ...
        self.assertIn(chess.Move.from_uci(chess.Board(), "c2c7"), plc)
        self.assertIn(chess.Move.from_uci(chess.Board(), "c2d3"), plc)
    ...
    def test_castling_is_legal(self):
        ...
        self.assertFalse(board.is_legal(chess.Move.from_uci(chess.Board(), "e1g1")))
        self.assertFalse(board.is_legal(chess.Move.from_uci(chess.Board(), "e1h1")))

        board.castling_rights |= chess.BB_H1
        self.assertTrue(board.is_legal(chess.Move.from_uci(chess.Board(), "e1g1")))
        self.assertTrue(board.is_legal(chess.Move.from_uci(chess.Board(), "e1h1")))
...
class PolyglotTestCase(unittest.TestCase):
    ...
    def test_castling(self):
        with chess.polyglot.open_reader("data/polyglot/performance.bin") as book:
            ...
            entry = book.find(pos)
            self.assertEqual(entry.move, chess.Move.from_uci(chess.Board(), "e1a1"))
    ...
    def test_random_choice(self):
        ...
        with chess.polyglot.open_reader("data/polyglot/performance.bin") as book:
            ...
            self.assertEqual(entry.move, chess.Move.from_uci(chess.Board(), "e2e4"))

            entry = book.choice(chess.Board(), random=LastMockRandom())
            self.assertEqual(entry.move, chess.Move.from_uci(chess.Board(), "c2c4"))
            ...
            entry = book.weighted_choice(chess.Board(), exclude_moves=[chess.Move.from_uci(chess.Board(), "e2e4")], random=FirstMockRandom())
            self.assertEqual(entry.move, chess.Move.from_uci(chess.Board(), "d2d4"))
    ...
    def test_exclude_moves(self):
        with chess.polyglot.open_reader("data/polyglot/performance.bin") as book:
            entry = book.find(chess.Board(), exclude_moves=[chess.Move.from_uci(chess.Board(), "e2e4")])
            self.assertEqual(entry.move, chess.Move.from_uci(chess.Board(), "d2d4"))
...
class PgnTestCase(unittest.TestCase):
    ...
    def test_promote_to_main(self):
        e4 = chess.Move.from_uci(chess.Board(), "e2e4")
        d4 = chess.Move.from_uci(chess.Board(), "d2d4")
    ...
    def test_comment_at_eol(self):
        ...
        node = game
        while node.variations and not node.has_variation(chess.Move.from_uci(chess.Board(), "a7a6")):
            node = node[0]
    ...
    def test_chess960_without_fen(self):
        ...
        game = chess.pgn.read_game(pgn)
        self.assertEqual(game[0].move, chess.Move.from_uci(chess.Board(), "e2e4"))
    ...
    def test_game_starting_variation(self):
        ...
        node = game[0]
        self.assertEqual(node.move, chess.Move.from_uci(chess.Board(), "e2e4"))
        self.assertFalse(node.comment)
        self.assertFalse(node.starting_comment)

        node = game[1]
        self.assertEqual(node.move, chess.Move.from_uci(chess.Board(), "d2d4"))
        self.assertFalse(node.comment)
    ...
    def test_annotation_symbols(self):
        ...
        node = game.variation(chess.Move.from_uci(chess.Board(), "b2b4"))
    ...
    def test_tricky_skip_game(self):
        ...
        pgn.seek(offsets[0])
        self.assertEqual(chess.pgn.read_game(pgn).next().move, chess.Move.from_uci(chess.Board(), "a2a3"))
        pgn.seek(offsets[1])
        self.assertEqual(chess.pgn.read_game(pgn).next().move, chess.Move.from_uci(chess.Board(), "b2b3"))
        pgn.seek(offsets[2])
        self.assertEqual(chess.pgn.read_game(pgn).next().move, chess.Move.from_uci(chess.Board(), "d2d3"))
    ...
    def test_read_headers(self):
        with open("data/pgn/kasparov-deep-blue-1997.pgn") as pgn:
            ...
            self.assertEqual(first_drawn_game[0].move, chess.Move.from_uci(chess.Board(), "d2d3"))
    ...
    def test_black_to_move(self):
        ...
        node = game
        node = node.add_main_variation(chess.Move.from_uci(chess.Board(), "e6d6"))
        node = node.add_main_variation(chess.Move.from_uci(chess.Board(), "e3d4"))
        node = node.add_main_variation(chess.Move.from_uci(chess.Board(), "d6e6"))
    ...
    def test_chessbase_empty_line(self):
        with open("data/pgn/chessbase-empty-line.pgn") as pgn:
            ...
            self.assertEqual(game.next().move, chess.Move.from_uci(chess.Board(), "e2e4"))
    ...
    def test_game_from_board(self):
        ...
        end_node = game.end()
        self.assertEqual(end_node.move, chess.Move.from_uci(chess.Board(), "c1c8"))
        self.assertEqual(end_node.parent.move, chess.Move.from_uci(chess.Board(), "d8e8"))
    ...
    def test_add_line(self):
        game = chess.pgn.Game()
        game.add_variation(chess.Move.from_uci(chess.Board(), "e2e4"))

        moves = [chess.Move.from_uci(chess.Board(), "g1f3"), chess.Move.from_uci(chess.Board(), "d7d5")]

        tail = game.add_line(moves, starting_comment="start", comment="end", nags=(17, 42))

        self.assertEqual(tail.parent.move, chess.Move.from_uci(chess.Board(), "g1f3"))
        ...
        self.assertEqual(tail.move, chess.Move.from_uci(chess.Board(), "d7d5"))
    ...
    def test_lan(self):
        ...
        game = chess.pgn.read_game(pgn)
        self.assertEqual(game.end().move, chess.Move.from_uci(chess.Board(), "e2e4"))
    ...
    def test_subgame(self):
        ...
        self.assertEqual(subgame.next().move, chess.Move.from_uci(chess.Board(), "c2c4"))
        self.assertEqual(subgame.variations[1].move, chess.Move.from_uci(chess.Board(), "g1f3"))
    ...
    def test_my_game_node(self):
        ...
        node = game.variation(chess.Move.from_uci(chess.Board(), "e2e4"))
    ...
    def test_node_turn(self):
        ...
        node = game.add_variation(chess.Move.from_uci(chess.Board(), "a2a3"))
        self.assertEqual(node.turn(), chess.BLACK)
        node = node.add_variation(chess.Move.from_uci(chess.Board(), "a7a6"))
        self.assertEqual(node.turn(), chess.WHITE)

        game = chess.pgn.Game()
        game.setup("4k3/8/8/8/8/8/8/4K3 b - - 7 6")
        self.assertEqual(game.turn(), chess.BLACK)
        node = game.add_variation(chess.Move.from_uci(chess.Board(), "e8e7"))
        self.assertEqual(node.turn(), chess.WHITE)
        node = node.add_variation(chess.Move.from_uci(chess.Board(), "e1e2"))
        self.assertEqual(node.turn(), chess.BLACK)
...
class EngineTestCase(unittest.TestCase):
    ...
    def test_uci_go(self):
        async def main():
            ...
            self.assertEqual(result.move, chess.Move.from_uci(chess.Board(), "d2d4"))
            self.assertEqual(result.ponder, chess.Move.from_uci(chess.Board(), "d7d5"))
    ...
    def test_uci_analyse_mode(self):
        async def main():
            ...
            self.assertEqual(best.move, chess.Move.from_uci(chess.Board(), "e2e4"))
            ...
            best = await result.wait()
            self.assertEqual(best.move, chess.Move.from_uci(chess.Board(), "e2e4"))
            self.assertEqual(best.ponder, chess.Move.from_uci(chess.Board(), "e7e5"))
            mock.assert_done()
    ...
    def test_uci_ponderhit(self):
        async def main():
            ...
            self.assertEqual(result.move, chess.Move.from_uci(chess.Board(), "d2d4"))
            self.assertEqual(result.ponder, chess.Move.from_uci(chess.Board(), "g8f6"))
            ...
            self.assertEqual(result.move, chess.Move.from_uci(chess.Board(), "c2c4"))
            self.assertEqual(result.ponder, chess.Move.from_uci(chess.Board(), "e7e6"))
            ...
            self.assertEqual(result.move, chess.Move.from_uci(chess.Board(), "b1c3"))
            self.assertEqual(result.ponder, chess.Move.from_uci(chess.Board(), "f8b4"))
            ...
            self.assertEqual(result.move, chess.Move.from_uci(chess.Board(), "d1c2"))
            self.assertEqual(result.ponder, chess.Move.from_uci(chess.Board(), "d7d5"))
            ...
            board.push(chess.Move.from_uci(chess.Board(), "c4d5"))
            board.push(chess.Move.from_uci(chess.Board(), "e6d5"))
            ...
            board.push(chess.Move.from_uci(chess.Board(), "c1g5"))
            board.push(chess.Move.from_uci(chess.Board(), "h7h6"))
    ...
    def test_uci_info(self):
        ...
        self.assertEqual(info["refutation"][chess.Move.from_uci(chess.Board(), "d1h5")], [chess.Move.from_uci(chess.Board(), "g6h5")])

        info = chess.engine._parse_uci_info("refutation d1h5", board)
        self.assertEqual(info["refutation"][chess.Move.from_uci(chess.Board(), "d1h5")], [])
        ...
        self.assertEqual(info["currline"][0], [chess.Move.from_uci(chess.Board(), "e2e4"), chess.Move.from_uci(chess.Board(), "e7e5")])
        ...
        self.assertEqual(info["pv"], [chess.Move.from_uci(chess.Board(), "g1f3"), chess.Move.from_uci(chess.Board(), "g8f6")])
    ...
    def test_hiarcs_bestmove(self):
        async def main():
            ...
            self.assertEqual(result.move, chess.Move.from_uci(chess.Board(), "g7g4"))
            self.assertEqual(result.ponder, chess.Move.from_uci(chess.Board(), "d4c3"))
            self.assertEqual(result.info["pv"], [chess.Move.from_uci(chess.Board(), "g7g4"), chess.Move.from_uci(chess.Board(), "d4c3")])
    ...
    def test_xboard_level(self):
        async def main():
            ...
            mock.expect_ping()
            result = await protocol.play(board, limit)
            self.assertEqual(result.move, chess.Move.from_uci(chess.Board(), "e2e4"))
            mock.assert_done()
...
#         Rb4 = chess.Move.from_uci(chess.Board(), "b3b4")
...
#         d1K = chess.Move.from_uci(chess.Board(), "d2d1k")
...
#         self.assertTrue(board.is_check())
#         Qa7 = chess.Move.from_uci(chess.Board(), "b6a7")
...
#         Nxc4 = chess.Move.from_uci(chess.Board(), "e3c4")
...
#         self.assertFalse(board.is_legal(chess.Move.from_uci(chess.Board(), "g1b1")))

#         # Kings are touching at the end.
#         board = chess.variant.AtomicBoard("8/8/8/8/8/8/2k5/rR4KR w KQ - 0 1", chess960=True)
#         self.assertTrue(board.is_legal(chess.Move.from_uci(chess.Board(), "g1b1")))
...
#         board.set_piece_at(chess.D1, chess.Piece.from_symbol(chess.Board(), "k"))
#         self.assertEqual(tables.probe_wdl(board), -2)
...
#         board.set_piece_at(chess.B1, chess.Piece.from_symbol(chess.Board(), "R"))
...
#         self.assertNotIn(chess.Move.from_uci(chess.Board(), "d1d3"), board.generate_legal_moves())

#         # Double pawn push from backrank possible.
#         self.assertIn(chess.Move.from_uci(chess.Board(), "e1e2"), board.generate_legal_moves())
#         self.assertTrue(board.is_legal(board.parse_san("e2")))
#         self.assertIn(chess.Move.from_uci(chess.Board(), "e1e3"), board.generate_legal_moves())
...
#         self.assertEqual(ops["bm"], [chess.Move.from_uci(chess.Board(), "h4f2")])
...
#         P_at_e6 = chess.Move.from_uci(chess.Board(), "P@e6")
...
#             game = chess.pgn.read_game(pgn)
#             self.assertEqual(game.end().board().move_stack[23], chess.Move.from_uci(chess.Board(), "N@f3"))
...
#         self.assertEqual(board.pop(), chess.Move.from_uci(chess.Board(), "e5d6"))
#         self.assertEqual(board.fen(), fen)
